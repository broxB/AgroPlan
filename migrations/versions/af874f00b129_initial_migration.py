...
Revision ID: af874f00b129
Revises: 
Create Date: 2022-10-03 13:05:09.263016
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['user_id'], ['user.user_id'], name=op.f('fk_base_field_user_id_user')),
    sa.PrimaryKeyConstraint('base_id', name=op.f('pk_base_field')),
    sa.UniqueConstraint('user_id', 'prefix', 'suffix', name=op.f('uq_base_field_user_id'))
    )
    ...
    sa.ForeignKeyConstraint(['user_id'], ['user.user_id'], name=op.f('fk_crop_user_id_user')),
    sa.PrimaryKeyConstraint('crop_id', name=op.f('pk_crop')),
    sa.UniqueConstraint('user_id', 'name', name=op.f('uq_crop_user_id'))
    )
    ...
    sa.ForeignKeyConstraint(['user_id'], ['user.user_id'], name=op.f('fk_fertilizer_user_id_user')),
    sa.PrimaryKeyConstraint('fertilizer_id', name=op.f('pk_fertilizer')),
    sa.UniqueConstraint('user_id', 'name', 'year', name=op.f('uq_fertilizer_user_id'))
    )
    ...
    sa.ForeignKeyConstraint(['fertilizer_name'], ['fertilizer.name'], name=op.f('fk_fertilizer_usage_fertilizer_name_fertilizer')),
    sa.ForeignKeyConstraint(['user_id'], ['user.user_id'], name=op.f('fk_fertilizer_usage_user_id_user')),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_fertilizer_usage')),
    sa.UniqueConstraint('user_id', 'fertilizer_name', 'year', name=op.f('uq_fertilizer_usage_user_id'))
    )
    ...
    sa.ForeignKeyConstraint(['base_id'], ['base_field.base_id'], name=op.f('fk_field_base_id_base_field')),
    sa.PrimaryKeyConstraint('field_id', name=op.f('pk_field')),
    sa.UniqueConstraint('base_id', 'sub_suffix', 'year', name=op.f('uq_field_base_id'))
    )
    ...
    sa.ForeignKeyConstraint(['base_id'], ['base_field.base_id'], name=op.f('fk_soil_sample_base_id_base_field')),
    sa.PrimaryKeyConstraint('sample_id', name=op.f('pk_soil_sample')),
    sa.UniqueConstraint('base_id', 'year', name=op.f('uq_soil_sample_base_id'))
    )
    ...
    sa.ForeignKeyConstraint(['crop_id'], ['crop.crop_id'], name=op.f('fk_cultivation_crop_id_crop')),
    sa.ForeignKeyConstraint(['field_id'], ['field.field_id'], name=op.f('fk_cultivation_field_id_field')),
    sa.PrimaryKeyConstraint('cultivation_id', name=op.f('pk_cultivation')),
    sa.UniqueConstraint('field_id', 'crop_class', name=op.f('uq_cultivation_field_id'))
    )
    op.create_table('field_soil_sample',
    sa.Column('field_id', sa.Integer(), nullable=True),
    sa.Column('sample_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['field_id'], ['field.field_id'], name=op.f('fk_field_soil_sample_field_id_field')),
    sa.ForeignKeyConstraint(['sample_id'], ['soil_sample.sample_id'], name=op.f('fk_field_soil_sample_sample_id_soil_sample'))
    )
    ...
    sa.ForeignKeyConstraint(['field_id'], ['field.field_id'], name=op.f('fk_saldo_field_id_field')),
    sa.PrimaryKeyConstraint('field_id', name=op.f('pk_saldo'))
    )
    ...
    sa.ForeignKeyConstraint(['cultivation_id'], ['cultivation.cultivation_id'], name=op.f('fk_fertilization_cultivation_id_cultivation')),
    sa.ForeignKeyConstraint(['fertilizer_id'], ['fertilizer.fertilizer_id'], name=op.f('fk_fertilization_fertilizer_id_fertilizer')),
    sa.PrimaryKeyConstraint('fertilization_id', name=op.f('pk_fertilization'))
    )
    op.create_table('field_fertilization',
    sa.Column('field_id', sa.Integer(), nullable=True),
    sa.Column('fertilization_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['fertilization_id'], ['fertilization.fertilization_id'], name=op.f('fk_field_fertilization_fertilization_id_fertilization')),
    sa.ForeignKeyConstraint(['field_id'], ['field.field_id'], name=op.f('fk_field_fertilization_field_id_field'))
    )
